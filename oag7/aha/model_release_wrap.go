...
func (o *ReleaseWrap) UnmarshalJSON(data []byte) (err error) {
	varReleaseWrap := _ReleaseWrap{}

	err = json.Unmarshal(data, &varReleaseWrap)

	if err != nil {
		return err
	}

	*o = ReleaseWrap(varReleaseWrap)
